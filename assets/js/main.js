...
function sendMessage() {
  ...
  // Отримання значення кожного поля форми
  ...
  fetch('https://api.byteplex.info/api/test/contact/', {
    ...
    .then(response => {
      if (response.ok) {
        // Якщо отримано успішний результат (200), вивести успішне повідомлення
        alert('successfully!');
      } else {
        // Інакше, вивести повідомлення про помилку
        alert('Error. Check the entered data or try again later');
      }
    })
    .catch(error => {
